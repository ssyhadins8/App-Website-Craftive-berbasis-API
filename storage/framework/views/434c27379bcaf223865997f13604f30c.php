    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('sellerDashboard', () => ({
            ...
            async init() {
                ...
                // Load shop details
                try {
                    const shopsRes = await fetch('<?php echo e(url("/api/shops")); ?>', {
                ...
                try {
                    const catRes = await fetch('<?php echo e(url("/api/categories")); ?>', {
                        headers: { 'X-API-KEY': 'craftive-public-key-2026' }
                    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp1\htdocs\craftive\resources\views/seller/dashboard.blade.php ENDPATH**/ ?>