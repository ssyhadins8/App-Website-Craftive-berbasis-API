...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>Halo, <?php echo e($userName); ?>!</h2>
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> <strong>Craftive Indonesia</strong>. Hak Cipta Dilindungi.<br>
...
<?php /**PATH C:\xampp1\htdocs\craftive\resources\views/emails/reset_otp.blade.php ENDPATH**/ ?>