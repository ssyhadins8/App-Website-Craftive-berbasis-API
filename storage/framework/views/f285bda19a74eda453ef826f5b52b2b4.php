...
<body class="font-sans min-h-screen flex items-center justify-center p-6 relative overflow-hidden" x-data="loginPage">
    ...
    <div class="bg-[#FCFAF7]/95 rounded-3xl border border-brand-beige shadow-2xl p-8 max-w-md w-full relative z-10">
        ...
        <p class="text-center text-xs text-brand-dark/80">
            Belum punya akun? 
            <a href="<?php echo e(route('register')); ?>" class="font-bold text-brand-terracotta hover:underline">Daftar Sekarang</a>
        </p>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('loginPage', () => ({
                ...
                async sendOtp() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(url("/api/auth/forgot-password")); ?>', {
                            method: 'POST',
                            headers: {
                ...
                async resetPassword() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(url("/api/auth/reset-password")); ?>', {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json',
                                'Content-Type': 'application/json',
                ...
                async submitLogin() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(url("/api/auth/login")); ?>', {
                            method: 'POST',
                            headers: {
                                'Accept': 'application/json',
                                'Content-Type': 'application/json',
                        ...
                        const sessionResponse = await fetch('<?php echo e(url("/login")); ?>', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
...
<?php /**PATH C:\xampp1\htdocs\craftive\resources\views/auth/login.blade.php ENDPATH**/ ?>