        ...
        <div x-show="activeTab === 'cart'" class="space-y-6">
            <div class="bg-white rounded-3xl border border-brand-beige shadow-xl p-6 md:p-8 relative">
                ...
                <div x-show="cartItems.length === 0" class="text-center py-20 relative z-10 flex flex-col items-center justify-center">
                    ...
                    <a href="<?php echo e(url('/products')); ?>" class="inline-block btn-gradient text-white px-8 py-3.5 rounded-xl font-bold text-xs mt-6 hover:shadow-lg hover:scale-[1.02] transition-all">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp1\htdocs\craftive\resources\views/user/dashboard.blade.php ENDPATH**/ ?>