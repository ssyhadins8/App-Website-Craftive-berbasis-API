...
<body class="font-sans antialiased min-h-screen flex flex-col" x-data="globalApp">
    ...
    <nav class="fixed top-0 left-0 w-full z-40 border-b border-brand-beige/50 glass-nav transition-all duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-24 items-center">
                ...
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-4 group">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-14 w-auto object-contain rounded-xl hover:scale-105 transition-transform duration-300" style="height: 56px !important; width: auto;" alt="Craftive Logo">
                ...
                <div class="hidden md:flex items-center gap-10 font-bold text-brand-dark/95 text-base">
                    <a href="<?php echo e(url('/')); ?>" class="hover:text-brand-terracotta transition-colors relative py-2 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-terracotta after:transition-all hover:after:w-full">Beranda</a>
                    <a href="<?php echo e(url('/products')); ?>" class="hover:text-brand-terracotta transition-colors relative py-2 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-terracotta after:transition-all hover:after:w-full">Produk</a>
                    <a href="<?php echo e(url('/')); ?>#kategori" class="hover:text-brand-terracotta transition-colors relative py-2 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-brand-terracotta after:transition-all hover:after:w-full">Kategori</a>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <template x-if="isLoggedIn && userRole === 'buyer'">
                        <a href="<?php echo e(url('/user/dashboard')); ?>#cart" class="relative bg-white/80 p-2.5 rounded-2xl hover:bg-brand-beige/20 transition-all border border-brand-beige flex items-center justify-center hover:scale-105 shadow-sm">
                             <span class="text-lg">
                    ...
                    <div class="hidden md:flex items-center gap-4">
                        ...
                        <template x-if="!isLoggedIn">
                            <div class="flex items-center gap-4 font-bold text-base">
                                <a href="<?php echo e(route('login')); ?>" class="text-brand-dark hover:text-brand-terracotta py-2.5 px-6 transition-colors">Masuk</a>
                                <a href="<?php echo e(route('register')); ?>" class="btn-gradient text-white py-3.5 px-8 rounded-2xl transition-all hover:shadow-lg shadow-brand-terracotta/20 hover:-translate-y-0.5">Daftar</a>
                            </div>
                        </template>
        ...
        <div x-show="mobileMenuOpen" x-transition class="md:hidden border-t border-brand-beige/50 px-4 py-6 bg-[#FDF6EE] flex flex-col gap-4 shadow-inner">
             <a href="<?php echo e(url('/')); ?>" class="font-bold text-brand-dark hover:text-brand-terracotta py-2">Beranda</a>
             <a href="<?php echo e(url('/products')); ?>" class="font-bold text-brand-dark hover:text-brand-terracotta py-2">Produk</a>
             <a href="<?php echo e(url('/')); ?>#kategori" class="font-bold text-brand-dark hover:text-brand-terracotta py-2">Kategori</a>
            ...
            <template x-if="!isLoggedIn">
                <div class="flex flex-col gap-2 w-full">
                    <a href="<?php echo e(route('login')); ?>" class="w-full text-center border border-brand-terracotta text-brand-terracotta py-3 rounded-2xl font-bold">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="w-full text-center btn-gradient text-white py-3 rounded-2xl font-bold">Daftar</a>
                </div>
            </template>
    ...
    <footer class="bg-brand-dark text-brand-cream border-t border-brand-beige/10 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" class="h-10 w-auto object-contain rounded-xl bg-white/10 p-1" style="height: 40px !important; width: auto;" alt="Craftive Logo">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-brand-cream/60 text-sm">
                        <li><a href="<?php echo e(url('/')); ?>" class="hover:text-brand-gold transition-colors font-semibold">Beranda</a></li>
                        <li><a href="<?php echo e(url('/products')); ?>" class="hover:text-brand-gold transition-colors font-semibold">Produk</a></li>
                        <li><a href="<?php echo e(url('/')); ?>#kategori" class="hover:text-brand-gold transition-colors font-semibold">Kategori</a></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-brand-beige/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-brand-cream/40">
                <p>&copy; <?php echo e(date('Y')); ?> CRAFTIVE. Hak Cipta Dilindungi Undang-Undang. &middot; Proyek UAS Pemrograman API.</p>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('globalApp', () => ({
                ...
                getDashboardUrl() {
                    if (this.userRole === 'admin') return '<?php echo e(url("/admin/dashboard")); ?>';
                    if (this.userRole === 'seller') return '<?php echo e(url("/seller/dashboard")); ?>';
                    return '<?php echo e(url("/user/dashboard")); ?>';
                },
                ...
                async logout() {
                    ...
                    try {
                        await fetch('<?php echo e(url("/logout")); ?>', {
                            method: 'POST',
                            headers: {
                ...
                async apiFetch(url, options = {}) {
                    ...
                    try {
                        const fullUrl = url.startsWith('http') ? url : `<?php echo e(url('')); ?>${url}`;
...
</html><?php /**PATH C:\xampp1\htdocs\craftive\resources\views/layouts/app.blade.php ENDPATH**/ ?>